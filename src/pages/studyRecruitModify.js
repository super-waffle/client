...
import StudyDatePickerEnd from "../components/datepickerEnd";
...
export default function StudyRecruitModify() {
    ...
    if (isLogin) {
      ...
      axios
        ...
        .then((res) => {
          ...
          setStudyTitle(apidata.studyTitle);
          setStudyShotrDesc(apidata.studyShortDesc);
          setStudyDesc(apidata.studyDesc);
          setStudyRecruitEnd(apidata.studyRecruitEnd);
          setCategoryName(apidata.categoryName);
          setDays(apidata.days);
          
        });

        axios
        .get(process.env.REACT_APP_SERVER_URL + "/categories/favorite", {
          headers: {
            Authorization: `Bearer ${TOKEN}`,
          },
        })
  ...
  return (
    <div className="recruit-create">
          ...
          <table>
            <tbody>
              <tr>
                ...
                <td className="recruit-create-content-row a3">
                  {studyRecruitEnd&&(
                    <StudyDatePickerEnd studyRecruitEnd={studyRecruitEnd} />
                  )}
                </td>
              </tr>
            </tbody>
      ...
      <center>
        <button onClick={onSubmitStudy}>스터디 수정</button>
      </center>
