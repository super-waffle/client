    ...
    <div className="if">
      ...
      <div className="if-body">
        <div className="if-body__box">
          ...
          <div className="if-body__box-body">{parseInt(timeTotal / 3).toLocaleString('ko-KR')}개 제조</div>
        </div>
        <div className="if-body__box">
          <div className="if-body__box-header">서울에서 뉴욕까지</div>
          <div className="if-body__box-body">{(timeTotal / 1680).toFixed(1)}회 왕복</div>
        </div>
        <div className="if-body__box">
          <div className="if-body__box-header">1분 영어단어</div>
          <div className="if-body__box-body">{timeTotal.toLocaleString('ko-KR')}개 암기</div>
        </div>
        <div className="if-body__box">
          <div className="if-body__box-header">책읽기</div>
          <div className="if-body__box-body">{parseInt(timeTotal / 150)}권</div>
        </div>
        <div className="if-body__box">
          <div className="if-body__box-header">걸어서</div>
          <div className="if-body__box-body">{(parseInt(timeTotal / 60) * 235).toLocaleString('ko-KR')}kcal 소모</div>
        </div>
        <div className="if-body__box">
          <div className="if-body__box-header">노래방에서</div>
          <div className="if-body__box-body">{parseInt(timeTotal / 3.75).toLocaleString('ko-KR')}곡 부르기</div>
        </div>
        <div className="if-body__box">
        ...
        <div className="if-body__box">
          ...
          <div className="if-body__box-body">{(timeTotal / 127).toFixed(1)}편</div>
        </div>
      </div>
    </div>
  );
